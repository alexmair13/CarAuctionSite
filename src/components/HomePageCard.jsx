const HomePageCard = ({text, image}) => {
    const style = 'relative bg-racing-green m-2 rounded-xl p-2 max-w-72 flex flex-col items-center transition duration-700 ease-in-out hover:opacity-60 border border-tan';
